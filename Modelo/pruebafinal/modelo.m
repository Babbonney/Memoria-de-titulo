...
tiempo= d_motores.timestamp/1000000;
tiempo2= d_vel.timestamp/1000000;
tiempo= tiempo-tiempo(1);
tiempo2= tiempo2-tiempo2(1);
...
u1 = interp1(tiempo, u1_raw, t_ref, 'previous', 'extrap');
u2 = interp1(tiempo, u2_raw, t_ref, 'previous', 'extrap');
u3 = interp1(tiempo, u3_raw, t_ref, 'previous', 'extrap');
