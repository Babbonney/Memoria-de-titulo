function fval = isrobctrlinvMPT(A,B,X,U,E,W,lambda)
...
%     X:       Polyhedron to be checked in polyhedron form (MPT toolbox).
%     W:       Disturbance set in polyhedron form (MPT toolbox), i.e. w_k \in W.
...
Q = k1setMPT(A,B,X,U,X,0,lambda,E,W);
fval = Q.contains(X);
