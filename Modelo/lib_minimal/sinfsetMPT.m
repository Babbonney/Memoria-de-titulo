function [Sinf,tstar,fd] = sinfsetMPT(A,B,X,U,T,tmax,lambda,tol)
...
%      X:    State constraints in polyhedral form (MPT toolbox).
%      U:    Control constraints in polyhedral form (MPT toolbox).
%      T:    Control invariant target set in polyhedral form (MPT toolbox).
...
[Sinf,tstar,fd] = kinfsetMPT(A,B,[],X,U,[],T,tmax,lambda,tol);