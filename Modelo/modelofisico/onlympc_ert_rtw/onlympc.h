...
struct B_onlympc_T {
  sbYdmyzq7l8Oes4F6y6cc2C_onlym_T WorkingSet;
  sbYdmyzq7l8Oes4F6y6cc2C_onlym_T b_workingset;
  sOWFOmKuLvD2kpFwfdM45bG_onlym_T CholRegManager;
  ssq2hyGkLOLhNlUBS6YfcCD_onlym_T QRManager;
  sFevNsrsl34D5b5aqm3qNjD_onlym_T memspace;
  real_T B[1072];
  real_T b_H[225];
  sqvdR3NQrfOjUOrC18Muj0B_onlym_T solution;
  real_T work[67];
  real_T vn1[67];
  real_T vn2[67];
  real_T work_m[67];
  real_T c_x[66];
  s3c01M66EFWFQJ5qmFcUbmD_onlym_T QPObjective;
  real_T A[16];
  real_T work_c[16];
  real_T uvec[15];
  real_T f[15];
  ...
  sqZVQFgLZG74FDpCArykMHB_onlym_T expl_temp;
  real32_T motorValues[12];
  real32_T motorValues_k[12];
  real32_T servoValues[8];
  real_T B_c[4];
  real_T u[3];                         // '<Root>/MATLAB Function5'
  sIOJhD9KwAkF5sEguPjYquC_onlym_T expl_temp_b;
  sIOJhD9KwAkF5sEguPjYquC_onlym_T expl_temp_p;
  sIOJhD9KwAkF5sEguPjYquC_onlym_T expl_temp_c;
  sIOJhD9KwAkF5sEguPjYquC_onlym_T expl_temp_f;
...
struct DW_onlympc_T {
  sCBS0Ia3qD76sOwKERvBoFE_onlym_T opts;// '<Root>/MATLAB Function5'
...
extern "C"
{
  ...
  extern struct B_onlympc_T onlympc_B;
...
extern struct DW_onlympc_T onlympc_DW;
...
extern "C"
{
  ...
  extern void onlympc_initialize(void);
  extern void onlympc_step(void);
  extern void onlympc_terminate(void);
...
extern "C"
{
  ...
  extern RT_MODEL_onlympc_T *const onlympc_M;
...
//
//  '<Root>' : 'onlympc'
//  '<S1>'   : 'onlympc/MATLAB Function'
//  '<S2>'   : 'onlympc/MATLAB Function5'
//  '<S3>'   : 'onlympc/Vehicle Attitude'
//  '<S4>'   : 'onlympc/Vehicle Attitude/PX4 uORB Read'
//  '<S5>'   : 'onlympc/Vehicle Attitude/PX4 uORB Read/Enabled Subsystem'
