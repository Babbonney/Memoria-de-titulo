...
void multipid_step0(void)              // Sample time: [0.001s, 0.0s]
{
  ...
  if (multipid_B.In1_k.values[3] > multipid_P.DeadZone3_End) {
    u0 = static_cast<real32_T>(multipid_B.In1_k.values[3]) -
  ...
  u0 = (u0 - 1494.0F) / 409.5F;

  // Saturate: '<S6>/Saturation3'
  if (u0 > multipid_P.Saturation3_UpperSat) {
    u0 = multipid_P.Saturation3_UpperSat;
  } else if (u0 < multipid_P.Saturation3_LowerSat) {
    u0 = multipid_P.Saturation3_LowerSat;
  }
  ...
  multipid_B.Product = (u0 - multipid_B.yawspeed) * static_cast<real32_T>
    (rtb_Switch);
  ...
  if (multipid_B.In1_k.values[2] > multipid_P.DeadZone2_End) {
    u0 = static_cast<real32_T>(multipid_B.In1_k.values[2]) -
  ...
  u0 = (u0 - 1084.0F) / 819.0F;

  // Saturate: '<S6>/Saturation2'
  if (u0 > multipid_P.Saturation2_UpperSat) {
    u0 = multipid_P.Saturation2_UpperSat;
  } else if (u0 < multipid_P.Saturation2_LowerSat) {
    u0 = multipid_P.Saturation2_LowerSat;
  }

  // Gain: '<Root>/Gain2' incorporates:
  //   Saturate: '<S6>/Saturation2'

  rtb_Gain2 = multipid_P.Gain2_Gain * u0;

  // MATLAB Function: '<Root>/MATLAB Function'
  M1_tmp = 0.707107F * rtb_MultiportSwitch_idx_0;
  u0 = 0.707107F * rtb_MultiportSwitch_idx_1;
  rtb_MultiportSwitch_idx_0 = rtb_Gain2 - M1_tmp;
  multipid_B.M1 = (rtb_MultiportSwitch_idx_0 + u0) + rtb_MultiportSwitch_idx_2;
  rtb_MultiportSwitch_idx_1 = M1_tmp + rtb_Gain2;
  multipid_B.M2 = (rtb_MultiportSwitch_idx_1 - u0) + rtb_MultiportSwitch_idx_2;
  multipid_B.M3 = (rtb_MultiportSwitch_idx_1 + u0) - rtb_MultiportSwitch_idx_2;
  multipid_B.M4 = (rtb_MultiportSwitch_idx_0 - u0) - rtb_MultiportSwitch_idx_2;
  ...
  if (multipid_B.In1_k.values[0] > multipid_P.DeadZone_End) {
    u0 = static_cast<real32_T>(multipid_B.In1_k.values[0]) -
  ...
  if (u0 > multipid_P.Saturation_UpperSat) {
    u0 = multipid_P.Saturation_UpperSat;
  } else if (u0 < multipid_P.Saturation_LowerSat) {
    u0 = multipid_P.Saturation_LowerSat;
  }
  ...
  rtb_DeadZone = multipid_P.Gain_Gain * u0 - rt_atan2f_snf((multipid_B.In1.q[0] *
    multipid_B.In1.q[1] + multipid_B.In1.q[2] * multipid_B.In1.q[3]) * 2.0F,
    ((multipid_B.In1.q[0] * multipid_B.In1.q[0] - multipid_B.In1.q[1] *
      multipid_B.In1.q[1]) - multipid_B.In1.q[2] * multipid_B.In1.q[2]) +
    multipid_B.In1.q[3] * multipid_B.In1.q[3]);
  ...
  if (multipid_B.In1_k.values[1] > multipid_P.DeadZone1_End_o) {
    u0 = static_cast<real32_T>(multipid_B.In1_k.values[1]) -
  ...
  u0 = (u0 - 1496.0F) / 409.5F;

  // Saturate: '<S6>/Saturation1'
  if (u0 > multipid_P.Saturation1_UpperSat) {
    u0 = multipid_P.Saturation1_UpperSat;
  } else if (u0 < multipid_P.Saturation1_LowerSat) {
    u0 = multipid_P.Saturation1_LowerSat;
  }
  ...
  rtb_DeadZone = multipid_P.Gain1_Gain * u0 - static_cast<real32_T>(asin(
    static_cast<real_T>((multipid_B.In1.q[1] * multipid_B.In1.q[3] -
...
void multipid_initialize(void)
{
  ...
  // External mode info
  multipid_M->Sizes.checksums[0] = (3080489390U);
  multipid_M->Sizes.checksums[1] = (2000701445U);
  multipid_M->Sizes.checksums[2] = (1256731931U);
  multipid_M->Sizes.checksums[3] = (2004934015U);
